...
import CeciliaNails from "../../../../../assets/images/ProjectImages/ceciliaNails.png"

function SectionProjectsImages() {
    return(
        <>
            <SectionProjectsImagesLinks link="https://www.cecilia-nails.fr" src={CeciliaNails} alt="Site CeciliaNails" rounded="rounded-bl-2xl rounded-br-2xl" />
